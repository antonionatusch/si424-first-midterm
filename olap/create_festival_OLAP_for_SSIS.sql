...
IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = 'Festival_Final_OLAP_From_SSIS')
BEGIN
    CREATE DATABASE Festival_Final_OLAP_From_SSIS;
    PRINT 'Database Festival_Final_OLAP_From_SSIS created.';
END
ELSE
    PRINT 'Database Festival_Final_OLAP_From_SSIS already exists.';
GO

USE Festival_Final_OLAP_From_SSIS;
GO
